...
import {USER_MUTATIONS} from "@webapp/user/store/user_store";
import {
    COURSES_LISTING_MUTATIONS, CoursesListingAccessors,
    coursesListingActions} from "@webapp/user/store/courses_listing_store";
import {userHttpService} from "@webapp/user/user_http_service";
import {CourseDescription} from "@shared/courses";
import {COURSE_MUTATIONS, CourseMode} from "@webapp/course/course_store";
import {
