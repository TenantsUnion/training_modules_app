...
import {courseSlugToIdMap, determineSlugs} from "@webapp/global/course_description_util";
import {AppGetter, RootState, VuexModule, VuexModuleConfig} from "@store/store_types";
