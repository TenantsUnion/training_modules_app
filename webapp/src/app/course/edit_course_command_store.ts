...
import {RootGetters, RootState, TypedAction, VuexModule, VuexModuleConfig} from '@webapp_root/store';
...
import {CreateSectionEntityPayload, CreateSectionResponse, SaveSectionEntityPayload} from "@shared/sections";
