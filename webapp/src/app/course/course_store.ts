...
import {AppGetter, RootGetters, RootState, TypedAction, VuexModule, VuexModuleConfig} from '@webapp_root/store';
import {titleToSlug} from '@shared/slug/title_slug_transformations';
import {GetterTree, Mutation, MutationTree} from "vuex";
import Vue from "vue";
import {COURSES_LISTING_ACTIONS} from "@user/store/courses_listing_store";
