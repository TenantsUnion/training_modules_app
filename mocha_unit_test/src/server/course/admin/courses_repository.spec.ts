...
import {CourseEntity} from "@shared/courses";              SELECT c.id, c.ordered_module_ids, c.ordered_question_ids, c.ordered_content_ids,
                c.ordered_content_question_ids, cp.*, m.modules FROM
                tu.course c
