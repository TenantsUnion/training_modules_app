...
import {contentRepository, coursesRepository} from "./repository.config";

export const accountController = new AccountController(accountHandler, userHandler, accountRequestValidator);
export const coursesController = new CoursesController(coursesHandler, coursesRepository);
